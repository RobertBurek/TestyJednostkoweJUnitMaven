...
public class EdgeTariffAppTest {
    ...
    public EdgeTariffAppTest(Integer kwhUsedInCase, boolean isTariffInCase, float sumKwhNoTariffInCase, float sumKwhTariffInCase) {
    ...
    //Dane wejściowe i wyjściowe w formie tablic w tablicy
    ...
    public static Collection inputData() {
        return Arrays.asList(new Object[][]{
                ...
                {200, false, 1750, 0},
                {400, false, 2150, 0},
                {150, false, 2311, 0}, //oczekiwany wynik 2300
                {100, false, 2400, 0},
                {100, false, 2500, 0},
                {100, false, 2600, 0},
                {100, false, 2700, 0},
                ...
                {100, true, 3200, 200},
                {1800, true, 3200, 2000},
                {2000, true, 3200, 4100}, //oczekiwany wynik 4000
                {100, false, 3300, 4000},
                {100, false, 3400, 4000},
                {100, false, 3500, 4000},
                {300, false, 3800, 4000},
