...
public class ExistAppTest {
    ...
    public static void init() {   //metoda wykonywana przed całą klasą AppTest, może mieć dowolną nazwę
        ...
        ExistAppTest.electrisityMeter = new App();
    ...
    public void addKwh_newMeter_properAddition1() {
        ...
        Assert.assertTrue(electrisityMeter.getKwhNoTariff() == 101);
    }
    ...
    public void addKwh_newMeter2_properAddition2() {
        ...
        Assert.assertTrue(electrisityMeter.getKwhNoTariff() == 105);
    }
    ...
    public void addKwh_newMeter5_properAddition3() {
        ...
        Assert.assertTrue(electrisityMeter.getKwhNoTariff() == 114);
    }
    ...
    public void addKwh_newMeter12_properAddition4() {
        ...
        Assert.assertTrue(electrisityMeter.getKwhNoTariff() == 178);
    }
    ...
    public void givenNewMeterWhenFirstAdditionThenProperCounterTwoAssert8() {
        electrisityMeter.addKwh(5);
        Assert.assertFalse("Dodano 5 kwh a czekiwano 7 kwh", electrisityMeter.getKwhNoTariff() == 107);
        // gdy pierwsza nie przejdzie nie mamy informacji o drugiej
        Assert.assertTrue("Dodano 5 kwh i oczekiwano 5 kwh", electrisityMeter.getKwhNoTariff() == 105);
    }
